              ...
              {activeJobsList.length === 0 ? (
                ...
                <div className="lg:grid lg:grid-cols-[1.1fr_1.3fr] gap-6 items-start">
                  ...
                  <div className="flex flex-col lg:h-[calc(100vh-200px)]">
                    <div className="flex-1 lg:overflow-y-auto pr-3 space-y-4 pb-10 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-base-300 [&::-webkit-scrollbar-thumb]:rounded-full">
