...
const SoftSkillsTips: React.FC = () => {
  ...
  return (
    <div className="bg-slate-800/60 border border-slate-700/50 rounded-xl p-5 shadow-xl backdrop-blur-sm">
      <h3 className="text-emerald-400 font-semibold text-base mb-4 flex items-center gap-2">
      ...
      <div className="space-y-4">
        {tips.map((tip, index) => (
          <div key={index} className="border-l-2 border-slate-600 pl-3 py-0.5">
            <h4 className="text-slate-200 text-sm font-medium mb-1">{tip.title}</h4>
